...
//   // console.log("user from store in leftsidebar file : ", user);
//   // console.log("like Notification from store in leftsidebar file : ", likeNotification);
...
//     dispatch(setLikeNotification({ type: 'clear' })); // Assuming 'clear' clears all notifications
//     console.log("handel notification clicked")
//   };
...
//                           <Button size='icon' className='rounded-full h-5 w-5 bg-red-600 absolute bottom-6 left-6'>{likeNotification.length}</Button>
//                         </PopoverTrigger>
