...
//   // console.log("user profile from profile page : ", userProfile);
//   // console.log("user  from profile page : ", user);

// //   // Check if the logged-in user is following that particuer user or not
// //   // const isFollowing = userProfile.followers.includes(user?._id);
//   const isFollowing = user.following.includes(userId);
//   const isLoggedInUserProfile = user?._id === userProfile?._id;
//   const dispatch = useDispatch();
//   // const isFollowing = true;
//   // console.log("is following from profile : " , isFollowing);
...
//       }
//     } catch (error) {
//       console.log('Error in follow or unfollow function in profile :', error);
//     }
//   };
...
// //   // console.log("displayed post from profile : ", displayedPost.length);
...
//                     isFollowing ? (
//                       <>
//                         <Button onClick={followORUnfollow} variant="secondary" className=" h-8 cursor-pointer" >
//                           Unfollow
//                         </Button>
//                         <Link to={"/chat"}> 
...
//                       </>
//                     ) : (
//                       <Button onClick={followORUnfollow} className="bg-[#0095F6]  hover:bg-[#3192d2] cursor-pointer">Follow</Button>
//                     )
//                   )
//                 }
//               </div>
...
//                 <p onClick={()=>{handleFollowersClick(); setFollowOrUnfollowTab("followers")}} className='cursor-pointer'><span className='font-semibold'>{userProfile?.followers.length} </span>followers</p>
//                 <p onClick={()=>{handleFollowersClick();setFollowOrUnfollowTab("following")}} className='cursor-pointer'><span className='font-semibold'>{userProfile?.following.length} </span>following</p>
//               </div>

//               <div className='flex flex-col gap-1'>
//                 <span className='font-semibold'> {userProfile?.bio ||
//                   'bio here...'} </span>
...
//           <div className='flex items-center justify-center gap-10 tex-sm'>
...
//           {
//             displayedPost.length > 0 ? (<div className='grid grid-cols-4 gap-1 '>
//               {
//                 displayedPost.map((post) => {
//                   // console.log("post is : ",post.comments.length)
//                   return (
...
//                         <div className='flex items-center text-white space-x-4 bg-green-300 px-2'>
...
//                     <p className='font-semibold text-xs'>When you share photos, they will appear on your profile.</p>
//                     <span onClick={createPostHandler} className='cursor-pointer font-medium text-[#0095F6] hover:text-[#1d577b] '>Share your first photo</span>
//                   </div>
//                 ) : (
...
//                       <Camera className='w-12 h-12' />
//                     </div>
//                     <span className='font-bold text-3xl'>No Post Yet</span>
//                   </div>
//                 )}
...
//       <FollowAndFollowers open={openFollowers} setOpen={setOpenFollowers} userId={userId} activeTab={followOrUnfollowTab} setActiveTab={setFollowOrUnfollowTab}/>
//     </div>
//   )
// }
